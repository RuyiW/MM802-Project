...
// }
// else{
// 	$delete_sql = "DELETE FROM bylaw_year WHERE bylaw_year = '$bylaw_year'"; //select data that matches
// 	if (mysqli_query($conn, $delete_sql)) {
...
// 	$delete_sql = "DELETE FROM checked_bylaw_result WHERE bylaw_year = '$bylaw_year'"; //select data that matches
// 	if (mysqli_query($conn, $delete_sql)) {
//     	//echo "The record deleted successfully";
//     	//echo "\n";
// 	} else {
