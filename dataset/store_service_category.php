...
$table_array = Array("service_category", "311_ward", "311_neighbourhood", "311_request_status");
//clear temp table
...
// 	$delete_sql = "DELETE FROM checked_311_result WHERE service_category = '$service_category'"; //select data that matches
// 	if (mysqli_query($conn, $delete_sql)) {
//     	//echo "The record deleted successfully";
//     	//echo "\n";
// 	} else {
